 ...
 * 
 */
// av, need, ava, need,ava


let current_user:string[] = ["piaic1","piaic2","piaic3","piaic4","piaic5"];
let new_user:string[]=["piaic6","piaic3","piaic7","piaic5","piaic8",];
for (let i = 0; i<new_user.length;i++){
    

    if(current_user.includes(new_user[i])){
        console.log("you will need to enter an other user name! ");
    }else{
